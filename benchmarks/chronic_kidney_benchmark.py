...
def main():
    ...
    candidates = [
        "kidney_disease.csv",
        os.path.join(script_dir, "..", "datasets", "kidney_disease.csv"),
        os.path.join(script_dir, "kidney_disease.csv")
    ]
    ...
    out_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "results", "chronic_kidney")
