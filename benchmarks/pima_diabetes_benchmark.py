...
def main():
    ...
    candidates = [
        "pima_diabetes.csv",
        os.path.join(script_dir, "..", "datasets", "pima_diabetes.csv"),
        os.path.join(script_dir, "pima_diabetes.csv")
    ]
    ...
    out_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "results", "pima_diabetes")
